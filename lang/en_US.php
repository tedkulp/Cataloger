...
$lang['title_item_image_size_section'] = 'Thumbnail image size for Item on Section Page (long axis in pixels)';
$lang['title_item_image_size_catalog'] = 'Thumbnail image size for Item on Catalog Page (long axis in pixels)';
$lang['title_section_image_size_hero'] = 'Image size for Section Page (long axis in pixels)';
$lang['title_section_image_size_thumbnail'] = 'Thumbail image size for Section Page (long axis in pixels)';
...
$lang['title_section_image_count']='Maximum number of Banner images for each Section Page';
...
$lang['title_section_attributes_help']='Each attribute you enter here will be the title of a field that you can use to describe an item section, and will be displayed on that section page. You may have to update your template to reflect these attributes. Blank out or type over an existing attribute to remove or replace it.';
...
$lang['title_section_sort'] = 'Section Page Item-list sort order';
$lang['title_section_recurse'] = 'Default Section Display Behavior';
$lang['title_section_recurse_items_all'] = 'Include all Items within this section, including items in sub-sections';
$lang['title_section_recurse_items_one'] = 'Include all Items immediately within this section, but not items in sub-sections';
$lang['title_section_recurse_sections_all'] = 'Include all Sections within this section, including sections in sub-sections';
$lang['title_section_recurse_sections_one'] = 'Include all Sections immediately within this section, but not sections in sub-sections';
$lang['title_section_recurse_mixed_all'] = 'Include all Items and Sections within this section, including items and sections in sub-sections';
$lang['title_section_recurse_mixed_one'] = 'Include all Items and Sections immediately within this section, but not items or sections in sub-sections';
...
<p>This module lets you create online catalogs or portfolios. Catalogs consist of "Catalog Items" which could be products, works of art, or the like, and "Catalog Sections" which could be item categories or other natural divisions of the catalog.</p>
<p>The module has built-in support for "Content Aliases" (a module available at <a href="http://www.cmsmodules.com/ContentAliases.html">CMSModules.com</a>), which allows you to place a Catalog Item into multiple Catalog Sections.</p>
<h3>How Do I Use It</h3>
<p>When you install this module, it creates two new Content Types: Catalog Item and Catalog Section. When you\'re in your site administration section, you add Catalog Items and Catalog Sections just as you would any other kind of page. Select Content &gt; Pages &gt; Add Content, and then select "Catalog Item" or "Catalog Section" from the Content Type pulldown.</p>
<h4>Catalog Items</h4>
<p>Adding a Catalog Item is similar to adding an ordinary page to your site. The data fields for the Item are not exactly the same, however. Also note that in the "Images" tab, you can select multiple images to upload for the item. When you upload images, the system will size them appropriately for the catalog, create thumbnails for use in the Item\'s page, create thumbnails for any Section pages, and so on. This requires that you have GD or a similar image library installed. Currently, only jpeg format images are supported.</p>
<h4>Catalog Sections</h4>
<p>A Catalog Section is used for organizing your catalog items into categories. It provides a page that lists the Catalog Items that are contained by it. A Catalog Item is considered to be part of a Catalog Section if it is below that Section in the Site Hierarchy. Sections can similarly include other Sections.</p>
<p>Catalog Sections have a number of settings to determine how they should display the Items and Sections they contain: if you look at the "Options" tab, you can choose how many items and/or sections to show, what order to show them in, whether to display only items or only sections or both, and how many levels of the hierarchy to display below the section page.</p>
...
<h4>Catalog Section Attributes</h4>
